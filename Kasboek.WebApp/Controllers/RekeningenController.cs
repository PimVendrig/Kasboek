...
namespace Kasboek.WebApp.Controllers
{
    public class RekeningenController : Controller
    {
        ...
        {
            return View(await _context.Rekeningen.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("RekeningId,RekeningNummer,Naam,IsEigenRekening")] Rekening rekening)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RekeningId,RekeningNummer,Naam,IsEigenRekening")] Rekening rekening)
        {
